 ...
 * @author Jhh
 */
public class AESCipher extends Cryptosystem{
    Cipher ecipher;

    Cipher dcipher;
    
    AESCipher(String text, boolean ciph, String key){
        this(text,ciph,stringToSecretKey(key));
    }
    
    AESCipher(String text, boolean ciph, SecretKey key) {
        try {
    ...
    public static void main(String[] argv) throws Exception {
        ...
        String sKey = AESCipher.secretKeyToString(key);
        AESCipher encrypter = new AESCipher("at at mid",true,sKey);
        String encrypted = encrypter.cipher();
        encrypter = new AESCipher(encrypted,false,key);
